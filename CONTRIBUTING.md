...
Для общих изменений используйте [рабочий процесс Git](docs/GIT_WORKFLOW.md) и
...
3. Дождитесь согласования спорного мода, неизвестного JAR, крупного launcher-изменения или
   breaking change.
4. Сделайте fork репозитория и создайте ветку от `main`.

## Ветка и Pull Request

Обычная contribution создаётся от `main`:
...
Откройте PR в `main`. Разрешите maintainer изменять ветку PR и заполните весь checklist.
