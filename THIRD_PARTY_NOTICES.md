...
- Обновления сборки устанавливает packwiz-installer 0.5.14, лицензия MIT. [Исходный код](https://github.com/packwiz/packwiz-installer).
- Для совместимости со старыми пользовательскими командами сохранён packwiz-installer-bootstrap 0.0.3, лицензия MIT. [Исходный код](https://github.com/packwiz/packwiz-installer-bootstrap).
